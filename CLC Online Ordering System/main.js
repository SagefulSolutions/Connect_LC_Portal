...
function MenuCreation() {
  ...
  for (let item in giomenu_early_mornin_fixins) {
    if (EarlyMorninFixins[item] != undefined) {
      ...
      document.write("<input type=\"checkbox\" class=\"menuitemcheckbox\" id=\"emfixins_"+item+"\"></input>"+EarlyMorninFixins[item]+" ... "+prices)
      document.write("<br />")
    }
  }
  ...
  for (let item in giomenu_sammiches) {
    ...
    if (Sammiches[item] != undefined) {
      ...
      document.write("<input type=\"checkbox\" class=\"menuitemcheckbox\" id=\""+Sammiches[item]+"\"></input>"+Sammiches[item]+" ... "+prices)
      document.write("<br />")  
    }
    num = num+1
  }
