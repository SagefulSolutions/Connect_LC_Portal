...
function MenuCreation() { // Giovanni's Menu
  ...
  for (let item in giomenu_early_mornin_fixins) {
    if (EarlyMorninFixins[item] != undefined) {
      ...
      document.write("<input type=\"checkbox\" onclick=\"updateCheckBoxes()\" class=\"menuitemcheckbox\" id=\"emfixins_"+item+"\" name=\""+EarlyMorninFixins[item]+"\"></input>"+EarlyMorninFixins[item]+" ... "+prices)
      document.write("<br />")
    }
  }
  ...
  for (let item in giomenu_early_mornin_fixins) {
    if (FarmToTableBurgers[item] != undefined) {
      ...
      document.write("<input type=\"checkbox\" onclick=\"updateCheckBoxes()\" class=\"menuitemcheckbox\" id=\"f2tburgers_"+item+"\" name=\""+FarmToTableBurgers[item]+"\"></input>"+FarmToTableBurgers[item]+" ... "+prices)
      document.write("<br />")
    }
  }  
  ...
  for (let item in giomenu_sides) {
    if (SharedPlates[item] != undefined) {
      ...
      document.write("<input type=\"checkbox\" onclick=\"updateCheckBoxes()\" class=\"menuitemcheckbox\" id=\"sides_"+item+"\" name=\""+Sides[item]+"\"></input>"+Sides[item]+" ... "+prices)
      document.write("<br />")
    }
  }  
  ...
  for (let item in giomenu_salads) {
    if (Salads[item] != undefined) {
      ...
      document.write("<input type=\"checkbox\" onclick=\"updateCheckBoxes()\" class=\"menuitemcheckbox\" id=\"salads_"+item+"\" name=\""+Salads[item]+"\"></input>"+Salads[item]+" ... "+prices)
      document.write("<br />")
    }
  }  
  ...
  for (let item in giomenu_dinn_dinn) {
    if (DinnDinn[item] != undefined) {
      ...
      document.write("<input type=\"checkbox\" onclick=\"updateCheckBoxes()\" class=\"menuitemcheckbox\" id=\"dinndinn_"+item+"\" name=\""+DinnDinn[item]+"\"></input>"+DinnDinn[item]+" ... "+prices)
      document.write("<br />")
    }
  }
  ...
  for (let item in giomenu_farm_and_sea) {
    if (FarmandSea[item] != undefined) {
      ...
      document.write("<input type=\"checkbox\" onclick=\"updateCheckBoxes()\" class=\"menuitemcheckbox\" id=\"farmsea_"+item+"\" name=\""+FarmandSea[item]+"\"></input>"+FarmandSea[item]+" ... "+prices)
      document.write("<br />")
    }
  }
  ...
  for (let item in giomenu_sammiches) {
    ...
    if (Sammiches[item] != undefined) {
      ...
      document.write("<input type=\"checkbox\" onclick=\"updateCheckBoxes()\" class=\"menuitemcheckbox\" id=\"sammiches_"+item+"\" name=\""+Sammiches[item]+"\"></input>"+Sammiches[item]+" ... "+prices)
      document.write("<br />")  
    }
    num = num+1
  }
